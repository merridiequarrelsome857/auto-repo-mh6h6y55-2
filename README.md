...
## 📚 Features
- Automatically manage Python project dependencies.
- Simplify project setup with user-friendly configuration.
...
Once installed, launch the application. You should see an easy-to-use interface where you can manage your Python projects. Here’s how to perform basic tasks:

### 📂 Create a New Project
1. Click on the "New Project" button.
2. Enter your project name and select a location for it.
...
2. Adjust preferences such as project template and default environment.
3. Save your changes.
